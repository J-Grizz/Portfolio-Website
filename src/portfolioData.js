...
const CVObject = {
  desc: {
    ...
    content: ["I am a driven optimist who enjoys challenging the status quo. After one year at varsity, I went on to complete my yacht masters and sailed all around the world. It was while working as a waiter that I discovered programming. Currently, I aspire to become a front-end UX developer."]
  },
  exp: {
    topic: "Experience",
